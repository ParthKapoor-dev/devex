---
title: Self-hosting
description: Run DevEx workspaces on your own Kubernetes cluster, with the core API on a Docker Swarm host. Any provider; one public node, no cloud load balancer.
updated: "2026-09-13"

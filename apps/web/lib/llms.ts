...
export function llmsIndex(): string {
  ...
  return [
    ...
    link("/pricing.md", "Pricing", `Plans and limits.${free ? ` The free tier gives ${free.specs[0]} workspaces at ${free.specs[1]} CPU and ${free.specs[2]} memory each, no card.` : ""}`),
    "",
    "## API and integration",
    "",
    ...
    link("/docs/mcp", "MCP server", "An optional sidecar that lets an assistant read a workspace's files over the Model Context Protocol. Tools today: Ping and read_file."),

...
// MOCK — vendored from React Bits (MIT + Commons Clause), https://reactbits.dev
// Phosphor copy of components/mocks/faulty-terminal.tsx. One change: `pause`
// is read from a ref and actually stops the rAF loop, instead of sitting in
// the effect deps (which tore down and rebuilt the GL context on every toggle
// while the paused loop kept rendering the same frame at 60fps).

 ...
 * The glow behind it is a plain radial gradient — a `blur()` filter inside a
 * transformed layer is re-rendered on every scroll frame.
 */
export default function Workspace() {
  ...
  return (
    <section id="workspace" aria-labelledby="workspace-title" className="relative px-4 pb-8 pt-28 sm:px-6 sm:pt-36">
      ...
      <div ref={ref} className="relative mx-auto mt-12 max-w-5xl [perspective:1100px]">
        <motion.div
        ...
        >
          <div
            aria-hidden="true"
            className="pointer-events-none absolute -inset-x-10 -top-10 bottom-1/3 -z-10 rounded-[50%] bg-[radial-gradient(ellipse_at_center,color-mix(in_oklab,var(--color-brand-600)_30%,transparent)_0%,transparent_70%)]"
          />
